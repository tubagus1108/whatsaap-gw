...
class ContactController extends Controller
{
    ...
    public function getContactByTagId($id, Request $request)
    {
        ...
        $html = view('pages.phonebook.datacontact', compact('contacts'))->render();
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($chck) return response()->json(['error' => true, 'msg' => 'Number already exists in this phonebook!']);

            $request->user()->contacts()->create($request->all());
            return response()->json(['error' => false, 'msg' => 'Success add contact!']);
        } catch (\Throwable $th) {
            return response()->json(['error' => true, 'msg' => 'Something errors!']);
        }
    }
    ...
    {
        $contact->delete();
        return response()->json(['error' => false, 'msg' => 'Success delete contact!']);
    }
    ...
    public function destroyAll(Request $request, $id)
    {
        try {
            ...
            return response()->json(['error' => false, 'msg' => 'Success delete all contact!']);
        } catch (\Throwable $th) {
            return response()->json(['error' => true, 'msg' => 'Something errors!']);
        }
    }
    ...
    public function import(Request $request)
    {
        try {
            ...
            return response()->json(['error' => false, 'msg' => 'Success import contact!']);
        } catch (\Throwable $th) {
